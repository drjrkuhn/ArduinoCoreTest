...
CArduinoCoreTestDeviceHub::CArduinoCoreTestDeviceHub()
  ...
  SetErrorText(ERR_PORT_OPEN_FAILED,
               "Failed opening ArduinoCoreTestDevice USB device");
  SetErrorText(
      ERR_BOARD_NOT_FOUND,
      "Did not find an ArduinoCoreTestDevice board with the correct firmware.  "
      "Is the ArduinoCoreTestDevice board connected to this serial port?");
  SetErrorText(ERR_NO_PORT_SET,
               "Hub Device not found.  The ArduinoCoreTestDevice Hub device is "
...
bool CArduinoCoreTestDeviceHub::SupportsDeviceDetection(void) { return true; }
