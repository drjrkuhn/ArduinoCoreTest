...
const char* g_DeviceNameArduinoCoreTestDeviceSwitch = "ArduinoCoreTestDevice-Switch";
const char* g_DeviceNameArduinoCoreTestDeviceShutter = "ArduinoCoreTestDevice-Shutter";
const char* g_DeviceNameArduinoCoreTestDeviceDA1 = "ArduinoCoreTestDevice-DAC1";
const char* g_DeviceNameArduinoCoreTestDeviceDA2 = "ArduinoCoreTestDevice-DAC2";
const char* g_DeviceNameArduinoCoreTestDeviceInput = "ArduinoCoreTestDevice-Input";
...
MODULE_API void InitializeModuleData()
{
   ...
   RegisterDevice(g_DeviceNameArduinoCoreTestDeviceSwitch, MM::StateDevice, "Digital out 8-bit");
   RegisterDevice(g_DeviceNameArduinoCoreTestDeviceShutter, MM::ShutterDevice, "Shutter");
   RegisterDevice(g_DeviceNameArduinoCoreTestDeviceDA1, MM::SignalIODevice, "DAC channel 1");
   RegisterDevice(g_DeviceNameArduinoCoreTestDeviceDA2, MM::SignalIODevice, "DAC channel 2");
   RegisterDevice(g_DeviceNameArduinoCoreTestDeviceInput, MM::GenericDevice, "ADC");
}
...
MODULE_API MM::Device* CreateDevice(const char* deviceName)
{
   ...
   else if (strcmp(deviceName, g_DeviceNameArduinoCoreTestDeviceSwitch) == 0)
   {
      return new CArduinoCoreTestDeviceSwitch;
   }
   else if (strcmp(deviceName, g_DeviceNameArduinoCoreTestDeviceShutter) == 0)
   {
      return new CArduinoCoreTestDeviceShutter;
   }
   else if (strcmp(deviceName, g_DeviceNameArduinoCoreTestDeviceDA1) == 0)
   {
      return new CArduinoCoreTestDeviceDA(1); // channel 1
   }
   else if (strcmp(deviceName, g_DeviceNameArduinoCoreTestDeviceDA2) == 0)
   {
      return new CArduinoCoreTestDeviceDA(2); // channel 2
   }
   else if (strcmp(deviceName, g_DeviceNameArduinoCoreTestDeviceInput) == 0)
   {
      return new CArduinoCoreTestDeviceInput;
   }
...
///////////////////////////////////////////////////////////////////////////////
// CArduinoCoreTestDeviceSwitch implementation
// ~~~~~~~~~~~~~~~~~~~~~~~~~~

CArduinoCoreTestDeviceSwitch::CArduinoCoreTestDeviceSwitch() : 
   nrPatternsUsed_(0),
   currentDelay_(0),
   sequenceOn_(false),
   blanking_(false),
   ...
   busy_(false)
{
   ...
   SetErrorText(ERR_COMMUNICATION, "Error in communication with ArduinoCoreTestDevice board");
   SetErrorText(ERR_NO_PORT_SET, "Hub Device not found.  The ArduinoCoreTestDevice Hub device is needed to create this device");
   ...
   // Description
   int ret = CreateProperty(MM::g_Keyword_Description, "ArduinoCoreTestDevice digital output driver", MM::String, true);
   assert(DEVICE_OK == ret);

   // Name
   ret = CreateProperty(MM::g_Keyword_Name, g_DeviceNameArduinoCoreTestDeviceSwitch, MM::String, true);
   assert(DEVICE_OK == ret);
...
void CArduinoCoreTestDeviceSwitch::GetName(char* name) const
{
   CDeviceUtils::CopyLimitedString(name, g_DeviceNameArduinoCoreTestDeviceSwitch);
}


int CArduinoCoreTestDeviceSwitch::Initialize()
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   ...
   // State
   // -----
   CPropertyAction* pAct = new CPropertyAction (this, &CArduinoCoreTestDeviceSwitch::OnState);
   ...
   pAct = new CPropertyAction(this, &CArduinoCoreTestDeviceSwitch::OnSequence);
   ...
   pAct = new CPropertyAction(this, &CArduinoCoreTestDeviceSwitch::OnBlanking);
   ...
   pAct = new CPropertyAction(this, &CArduinoCoreTestDeviceSwitch::OnBlankingTriggerDirection);
   ...
   pAct = new CPropertyAction(this, &CArduinoCoreTestDeviceSwitch::OnStartTimedOutput);
   ...
   // This delay will be transferred to the ArduinoCoreTestDevice using the Get and SetPattern commands
   pAct = new CPropertyAction(this, &CArduinoCoreTestDeviceSwitch::OnDelay);
   ...
   pAct = new CPropertyAction(this, &CArduinoCoreTestDeviceSwitch::OnRepeatTimedPattern);
...
int CArduinoCoreTestDeviceSwitch::Shutdown()
{
   initialized_ = false;
   return DEVICE_OK;
}

int CArduinoCoreTestDeviceSwitch::WriteToPort(long value)
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (!hub || !hub->IsPortAvailable()) {
      return ERR_NO_PORT_SET;
...
int CArduinoCoreTestDeviceSwitch::LoadSequence(unsigned size, unsigned char* seq)
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (!hub || !hub->IsPortAvailable())
      return ERR_NO_PORT_SET;
...
int CArduinoCoreTestDeviceSwitch::OnState(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (!hub || !hub->IsPortAvailable())
      return ERR_NO_PORT_SET;
...
int CArduinoCoreTestDeviceSwitch::OnSequence(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
      if (sequenceOn_)
...
int CArduinoCoreTestDeviceSwitch::OnStartTimedOutput(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (!hub || !hub->IsPortAvailable())
      return ERR_NO_PORT_SET;
...
int CArduinoCoreTestDeviceSwitch::OnBlanking(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (!hub || !hub->IsPortAvailable())
      return ERR_NO_PORT_SET;
...
int CArduinoCoreTestDeviceSwitch::OnBlankingTriggerDirection(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (!hub || !hub->IsPortAvailable())
      return ERR_NO_PORT_SET;
...
int CArduinoCoreTestDeviceSwitch::OnDelay(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet) {
...
int CArduinoCoreTestDeviceSwitch::OnRepeatTimedPattern(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (!hub || !hub->IsPortAvailable())
      return ERR_NO_PORT_SET;
...
///////////////////////////////////////////////////////////////////////////////
// CArduinoCoreTestDeviceDA implementation
// ~~~~~~~~~~~~~~~~~~~~~~

CArduinoCoreTestDeviceDA::CArduinoCoreTestDeviceDA(int channel) :
      busy_(false), 
      minV_(0.0), 
      maxV_(5.0), 
      volts_(0.0),
      ...
      gateOpen_(true)
{
   ...
   CPropertyAction* pAct = new CPropertyAction(this, &CArduinoCoreTestDeviceDA::OnChannel);
   ...
   */
   ...
   CPropertyAction* pAct = new CPropertyAction(this, &CArduinoCoreTestDeviceDA::OnMaxVolt);
   CreateProperty("MaxVolt", "5.0", MM::Float, false, pAct, true);

   name_ = channel_ == 1 ? g_DeviceNameArduinoCoreTestDeviceDA1 : g_DeviceNameArduinoCoreTestDeviceDA2;

   // Description
   int nRet = CreateProperty(MM::g_Keyword_Description, "ArduinoCoreTestDevice DAC driver", MM::String, true);
...
CArduinoCoreTestDeviceDA::~CArduinoCoreTestDeviceDA()
{
   Shutdown();
}

void CArduinoCoreTestDeviceDA::GetName(char* name) const
{
   CDeviceUtils::CopyLimitedString(name, name_.c_str());
}


int CArduinoCoreTestDeviceDA::Initialize()
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (!hub || !hub->IsPortAvailable()) {
      return ERR_NO_PORT_SET;
   ...
   // State
   // -----
   CPropertyAction* pAct = new CPropertyAction (this, &CArduinoCoreTestDeviceDA::OnVolts);
...
int CArduinoCoreTestDeviceDA::Shutdown()
{
   initialized_ = false;
   return DEVICE_OK;
}

int CArduinoCoreTestDeviceDA::WriteToPort(unsigned long value)
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (!hub || !hub->IsPortAvailable())
      return ERR_NO_PORT_SET;
...
int CArduinoCoreTestDeviceDA::WriteSignal(double volts)
{
...
int CArduinoCoreTestDeviceDA::SetSignal(double volts)
{
   volts_ = volts;
   if (gateOpen_) {
      gatedVolts_ = volts_;
...
int CArduinoCoreTestDeviceDA::SetGateOpen(bool open)
{
   if (open) {
      gateOpen_ = true;
      gatedVolts_ = volts_;
...
int CArduinoCoreTestDeviceDA::OnVolts(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
      // nothing to do, let the caller use cached property
...
int CArduinoCoreTestDeviceDA::OnMaxVolt(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
      pProp->Set(maxV_);
...
int CArduinoCoreTestDeviceDA::OnChannel(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
...
///////////////////////////////////////////////////////////////////////////////
// CArduinoCoreTestDeviceShutter implementation
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~

CArduinoCoreTestDeviceShutter::CArduinoCoreTestDeviceShutter() : initialized_(false), name_(g_DeviceNameArduinoCoreTestDeviceShutter)
{
   InitializeDefaultErrorMessages();
   EnableDelay();
   ...
   // Name
   int ret = CreateProperty(MM::g_Keyword_Name, g_DeviceNameArduinoCoreTestDeviceShutter, MM::String, true);
   assert(DEVICE_OK == ret);

   // Description
   ret = CreateProperty(MM::g_Keyword_Description, "ArduinoCoreTestDevice shutter driver", MM::String, true);
   assert(DEVICE_OK == ret);
...
CArduinoCoreTestDeviceShutter::~CArduinoCoreTestDeviceShutter()
{
   Shutdown();
}

void CArduinoCoreTestDeviceShutter::GetName(char* name) const
{
   CDeviceUtils::CopyLimitedString(name, g_DeviceNameArduinoCoreTestDeviceShutter);
}

bool CArduinoCoreTestDeviceShutter::Busy()
{
...
int CArduinoCoreTestDeviceShutter::Initialize()
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (!hub || !hub->IsPortAvailable()) {
      return ERR_NO_PORT_SET;
   ...
   // OnOff
   // ------
   CPropertyAction* pAct = new CPropertyAction (this, &CArduinoCoreTestDeviceShutter::OnOnOff);
...
int CArduinoCoreTestDeviceShutter::Shutdown()
{
   if (initialized_)
   {
      initialized_ = false;
...
int CArduinoCoreTestDeviceShutter::SetOpen(bool open)
{
	std::ostringstream os;
	os << "Request " << open;
	LogMessage(os.str().c_str(), true);
...
int CArduinoCoreTestDeviceShutter::GetOpen(bool& open)
{
...
int CArduinoCoreTestDeviceShutter::Fire(double /*deltaT*/)
{
   return DEVICE_UNSUPPORTED_COMMAND;
}

int CArduinoCoreTestDeviceShutter::WriteToPort(long value)
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (!hub || !hub->IsPortAvailable())
      return ERR_NO_PORT_SET;
...
int CArduinoCoreTestDeviceShutter::OnOnOff(MM::PropertyBase* pProp, MM::ActionType eAct)
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (eAct == MM::BeforeGet)
   {
...
/*
 * ArduinoCoreTestDevice input.  Can either be for all pins (0-6)
 * or for an individual pin only
 */

CArduinoCoreTestDeviceInput::CArduinoCoreTestDeviceInput() :
   mThread_(0),
   pin_(0),
   name_(g_DeviceNameArduinoCoreTestDeviceInput)
{
...
int CArduinoCoreTestDeviceInput::Shutdown()
{
   if (initialized_)
      delete(mThread_);
   initialized_ = false;
...
int CArduinoCoreTestDeviceInput::Initialize()
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (!hub || !hub->IsPortAvailable()) {
      return ERR_NO_PORT_SET;
   ...
   // Digital Input
   CPropertyAction* pAct = new CPropertyAction (this, &CArduinoCoreTestDeviceInput::OnDigitalInput);
   ...
   {
      CPropertyActionEx *pExAct = new CPropertyActionEx(this, &CArduinoCoreTestDeviceInput::OnAnalogInput, i);
      std::ostringstream os;
      os << "AnalogInput" << i;
   ...
   mThread_ = new ArduinoCoreTestDeviceInputMonitorThread(*this);
   mThread_->Start();
...
void CArduinoCoreTestDeviceInput::GetName(char* name) const
{
  CDeviceUtils::CopyLimitedString(name, name_.c_str());
}

bool CArduinoCoreTestDeviceInput::Busy()
{
   return false;
}

int CArduinoCoreTestDeviceInput::GetDigitalInput(long* state)
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (!hub || !hub->IsPortAvailable())
      return ERR_NO_PORT_SET;
...
int CArduinoCoreTestDeviceInput::ReportStateChange(long newState)
{
   std::ostringstream os;
   os << newState;
...
int CArduinoCoreTestDeviceInput::OnDigitalInput(MM::PropertyBase*  pProp, MM::ActionType eAct)
{
   if (eAct == MM::BeforeGet)
   {
      long state;
...
int CArduinoCoreTestDeviceInput::OnAnalogInput(MM::PropertyBase* pProp, MM::ActionType eAct, long  channel )
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (!hub || !hub->IsPortAvailable())
      return ERR_NO_PORT_SET;
...
int CArduinoCoreTestDeviceInput::SetPullUp(int pin, int state)
{
   CArduinoCoreTestDeviceHub* hub = static_cast<CArduinoCoreTestDeviceHub*>(GetParentHub());
   if (!hub || !hub->IsPortAvailable())
      return ERR_NO_PORT_SET;
...
int CArduinoCoreTestDeviceInput::ReadNBytes(CArduinoCoreTestDeviceHub* hub, unsigned int n, unsigned char* answer)
{
   MM::MMTime startTime = GetCurrentMMTime();
   unsigned long bytesRead = 0;
...
ArduinoCoreTestDeviceInputMonitorThread::ArduinoCoreTestDeviceInputMonitorThread(CArduinoCoreTestDeviceInput& aInput) :
   state_(0),
   aInput_(aInput)
{
}

ArduinoCoreTestDeviceInputMonitorThread::~ArduinoCoreTestDeviceInputMonitorThread()
{
   Stop();
   wait();
}

int ArduinoCoreTestDeviceInputMonitorThread::svc() 
{
   while (!stop_)
   {
      long state;
...
void ArduinoCoreTestDeviceInputMonitorThread::Start()
{
   stop_ = false;
   activate();
}
