...
class CArduinoCoreTestDeviceShutter : public CShutterBase<CArduinoCoreTestDeviceShutter>  
{
public:
   CArduinoCoreTestDeviceShutter();
   ~CArduinoCoreTestDeviceShutter();
...
class CArduinoCoreTestDeviceSwitch : public CStateDeviceBase<CArduinoCoreTestDeviceSwitch>  
{
public:
   CArduinoCoreTestDeviceSwitch();
   ~CArduinoCoreTestDeviceSwitch();
...
class CArduinoCoreTestDeviceDA : public CSignalIOBase<CArduinoCoreTestDeviceDA>  
{
public:
   CArduinoCoreTestDeviceDA(int channel);
   ~CArduinoCoreTestDeviceDA();
...
class CArduinoCoreTestDeviceInput : public CGenericBase<CArduinoCoreTestDeviceInput>  
{
public:
   CArduinoCoreTestDeviceInput();
   ~CArduinoCoreTestDeviceInput();
...
private:
   int ReadNBytes(CArduinoCoreTestDeviceHub* h, unsigned int n, unsigned char* answer);
   int SetPullUp(int pin, int state);

   MMThreadLock lock_;
   ArduinoCoreTestDeviceInputMonitorThread* mThread_;
...
class ArduinoCoreTestDeviceInputMonitorThread : public MMDeviceThreadBase
{
   public:
      ArduinoCoreTestDeviceInputMonitorThread(CArduinoCoreTestDeviceInput& aInput);
     ~ArduinoCoreTestDeviceInputMonitorThread();
      int svc();
      ...
      ArduinoCoreTestDeviceInputMonitorThread & operator=( const ArduinoCoreTestDeviceInputMonitorThread & ) 
      {
         return *this;
      }
   ...
   private:
      long state_;
      CArduinoCoreTestDeviceInput& aInput_;
      bool stop_;
};
